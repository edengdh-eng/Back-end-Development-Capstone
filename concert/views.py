...
def signup(request):
    # Case 1: User is requesting the signup form (GET request)
    if request.method == "GET":
        return render(request, "signup.html", {"form": SignUpForm()})

    # Case 2: User submitted the signup form (POST request)
    if request.method == "POST":
        ...
        return redirect("index")  # Replace "index" with your index route name

    # Fallback: just render the form
    return render(request, "signup.html", {"form": SignUpForm()})
